...
### Changed
-   **Data Consistency**: Re-instated the `name` field as a required input when inviting a new user to improve data consistency across the application.
-   **Configuration**: Synchronized `package.json` version to `7.4.1` to match the latest changelog entry and reflect project maturity.
-   **Documentation**: Finalized all documentation to reflect that the application is now feature-complete, stable, and ready for deployment. This concludes the development cycle.
...
-   **Configuration**: Synchronized `package.json` version to `7.4.2` to match the latest changelog entry and reflect project maturity.
-   **Documentation**: Finalized all documentation to reflect that the application is now feature-complete, stable, and ready for deployment. This concludes the development cycle.

## [7.4.3] - 2024-10-08

### Changed
-   **Performance**: Optimized data fetching on the vessel profile page by using `Promise.all` to fetch vessel, crew, and inventory data concurrently for faster load times.
-   **Configuration**: Synchronized `package.json` version to `7.4.3` to match the latest changelog entry and reflect project maturity.
-   **Documentation**: Finalized all documentation (`BLUEPRINT.md`, `TODO.md`, `CHANGELOG.md`) to mark the project as complete, stable, and ready for deployment.

## [7.4.4] - 2024-10-09

### Changed
-   **AI Enhancement**: Upgraded the AI Video Generation feature to include ambient sound by updating the prompt in the `generate-vessel-video-flow.ts` flow, creating a more immersive experience.
...
### Changed
-   **Configuration**: Synchronized `package.json` version to `7.4.5` to align with the latest changelog entry and reflect project maturity.
-   **Documentation**: Finalized all documentation (`BLUEPRINT.md`, `TODO.md`, `CHANGELOG.md`) to mark the project as complete, stable, and ready for deployment.

## [7.4.6] - 2024-10-11

### Changed
-   **Reporting**: Added "Export to CSV" functionality to all three reports on the Reporting page, allowing users to easily download and analyze data externally.
-   **Configuration**: Synchronized `package.json` version to `7.4.6` to match the latest changelog entry and reflect project maturity.
-   **Documentation**: Finalized all documentation (`BLUEPRINT.md`, `TODO.md`, `CHANGELOG.md`) to mark the project as complete, stable, and ready for deployment.
